...
local function apply()
  ...
  local groups = {
    ...
    -- Nvim-Navic
    NavicIconsFile = { fg = colors.yellow },
    ...
    NavicIconsMethod = { fg = colors.pink },
    ...
    NavicIconsEvent = { fg = colors.pink },
    NavicIconsOperator = { fg = colors.pink },
    NavicIconsTypeParameter = { fg = colors.purple },
    NavicText = { fg = colors.white, bg = colors.bg, bold = true },
    NavicSeparator = { fg = colors.white, bg = colors.bg, bold = true },
